...
public abstract class AbstractPlayStatusReceiver extends BroadcastReceiver {
	 ...
	 * @param mapi	the MusicAPI to use send this scrobble request
	 */
	 ...
	 * This is extracted into a specific {@link MusicAPI}, {@link Track} and state.
	 * 
	 * @see #setMusicAPI(MusicAPI)
	 * @see #setState(com.adam.aslfms.util.Track.State)
	 * @see #setTrack(Track)
	 * 
	 * @param ctx		to be able to create {@link MusicAPI}s
