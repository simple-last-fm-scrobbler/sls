...
## Problem or Issue?
  ...
  * Please create a [GitHub Account](https://github.com/join) so you can create a [GitHub Issue](https://github.com/simple-last-fm-scrobbler/sls/issues) and PLEASE use the next sections as guides. You will get help with bugs and problems with the software. For direct personal contact with developers, please use [Gitter](https://gitter.im/tgwizard/sls) or [Discord](https://discordapp.com/channels/722441132260458496).
